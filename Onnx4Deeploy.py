...
def generate_model(
    ...
    try:
        ...
        if mode in ("train", "train_single_step", "zo-train", "q-zo-train"):  # QW: ZO/QZO fixtures need the step count too -- QW
            import math
        ...
        if mode in ("train", "train_single_step", "zo-train", "q-zo-train"):  # QW: thread step count into ZO/QZO fixture -- QW
